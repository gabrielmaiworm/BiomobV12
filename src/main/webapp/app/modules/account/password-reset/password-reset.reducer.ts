  ...
  extraReducers(builder) {
    builder
      .addCase(handlePasswordResetInit.fulfilled, () => ({
        ...
        successMessage: 'Verifique seu email para detalhes de como resetar sua senha.',
      }))
      .addCase(handlePasswordResetFinish.fulfilled, () => ({
        ...initialState,
        loading: false,
        resetPasswordSuccess: true,
        successMessage: 'Sua senha não pode ser alterada. Lembre-se, um pedido para alterar a senha só pode ser efetuado a cada 24 horas.',
      }))
