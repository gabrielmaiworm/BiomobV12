  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="biomobV11App.item.home.createOrEditLabel" data-cy="ItemCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Descrição" id="item-descricao" name="descricao" data-cy="descricao" type="text" />
              ...
              <ValidatedField label="Categoria" id="item-categoriaItem" name="categoriaItem" data-cy="categoriaItem" type="select">
